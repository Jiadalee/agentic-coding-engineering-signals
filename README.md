...
This study presents a descriptive longitudinal analysis analyzing **33,228 merged Pull Requests** across two high-velocity AI infrastructure projects:
...
The repository structure matches the analysis pipeline and raw/processed data artifacts directly:

```text
.
├── raw_prs_full_population.csv       # Complete dataset (33,228 PRs)
├── raw_prs_bot_only.csv              # Sub-dataset of bot-authored PRs
├── pr_size_data.csv                  # Code volume, additions/deletions, and files changed
...
Era 1: Pre-Agentic Baseline / Early AI-Assisted Coding
Era 2: Early AI Coding Tools Expansion
Era 3: Vibe Coding Mainstream / Software Workflow Integration
Era 4: Agentic Coding Emergence
